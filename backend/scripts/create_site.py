...
from erico.training.interfaces import IBrowserLayer
...
if site_id not in app.objectIds():
    ...
    portal_setup.runAllImportStepsFromProfile("profile-erico.training:default")
    transaction.commit()

    if EXAMPLE_CONTENT:
        portal_setup.runAllImportStepsFromProfile("profile-erico.training:initial")
        transaction.commit()
    app._p_jar.sync()
