...
DEPLOY_ENV=prod
DEPLOY_HOST=erico-training.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for erico-training.example.com, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    erico-training.example.com:
      ansible_user: root
      host: erico-training
      hostname: erico-training.example.com
```
...
Deploy the stack defined in `devops/stacks/erico-training.example.com.yml` to the remote server with:
